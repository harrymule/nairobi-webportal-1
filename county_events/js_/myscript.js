	...
	/**
	  ...
	  */
	  ...
	  var nextArrow = document.createElement("img");
	  	  nextArrow.setAttribute("src", "images/monthForward_normal.gif");
	  ...
	  var wday = today.getDay();
	    ...
	    //alert(wday); //Fri Apr 18 2014 12:50:55 GMT +0300 (E.Africa Standard Time)
	 	//Loop Determines what day of week is the 1st day of this month.
	  	...
	  	//alert(curMaxMonDays);
	  	fillMonDays(wday, initMaxMonDays);
...
/************************************************** MY FUNCTIONS *******************************************************/
	/**
	  ...
	  * 
	  */
	function fillMonDays(wday, numDays){
		//alert("wday = "+ wday);
	...
	/**
	  ...
	  */
		...
		function backOneMonth(){
			...
			fillMonDays(prevMonDayIndex, maxMonDays);
	...
	/**
	  ...
	  */
		function nextOneMonth(){
			...
			fillMonDays(nextMonDayIndex, maxMonDays);
